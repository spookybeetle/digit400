...
(MRW)Be sure to define variables **constants and variables** before they appear in your code!
...
(MRW) The text that appeared in the file prior to us getting there can be safely commented out.
...
scene.add( cube );
```
(MRW) If we want to change the color we can use "rgb(0,0,0)" in the spot where it says color.
...
(MRW) Everything needs to go in front of this animate() function, or it won't animate (at least on my computer).
```
...
- (MRW) The background has to be a .png or .jpg with this function. .gif files will not animate/work.
...
(MRW) You can simply move the constants to where your other shapes are to add texture mapping to them. Just rename them and change the variables to match the other shape.
...
(MRW) After getting through all this code, your main.js file should look like this:
![Full main.js file begining](images/screenshots/1.png)
![Full main.js file middle 1](images/screenshots/2.png)
![Full main.js file middle 2](images/screenshots/3.png)
![Full main.js file ending](images/screenshots/4.png)
